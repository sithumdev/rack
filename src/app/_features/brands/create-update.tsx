...
export default function CreateUpdateBrand({
  ...
  const {
    ...
    formState: { errors },
    reset,
  } = useForm<CreateBrandSchemaType>({
    resolver: zodResolver(CreateBrandSchema),
  });

  const onSubmit: SubmitHandler<CreateBrandSchemaType> = async (data) => {
  ...
  return (
    ...
    >
      <div data-testid="inner">
        <Dialog.Header id="header">Create Brand</Dialog.Header>
